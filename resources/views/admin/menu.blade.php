...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <a href="{{ route('tambahMenu') }}" class="btn btn-primary btn-sm"
    ...
    @include('admin.modal.modal-action-menu') <!-- modal edit & hapus -->
    <script>
        // Edit Menu
        ...
        editModal.addEventListener('show.bs.modal', function(event) {
            ...
            editModal.querySelector('form').action = '/menu/' + id + '/updateadmin';
        });
        ...
        deleteModal.addEventListener('show.bs.modal', function(event) {
            var button = event.relatedTarget;
            var id = button.getAttribute('data-id');
            deleteModal.querySelector('form').action = '/menu/' + id + '/deleteadmin';
        });
    </script>
@endsection
