    ...
    <nav class="pc-sidebar d-flex flex-column">
        <div class="navbar-wrapper d-flex flex-column">
            ...
            <div class="m-header flex items-center justify-center gap-2 h-full">
                ...
                <!-- Nama brand -->
                <a href="{{ route('dashboardUser') }}" class="text-2xl font-extrabold" style="color: #fc6600;">
                    COFFE ADDICT
                </a>
            </div>
            ...
            <div class="navbar-content d-flex flex-column">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('dashboardUser') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-dashboard"></i></span>
                            <span class="pc-mtext">Dashboard</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="{{ route(name: 'menuUser') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-credit-card"></i></span>
                            <span class="pc-mtext">Menu </span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="{{ route('mejaUser') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-credit-card"></i></span>
